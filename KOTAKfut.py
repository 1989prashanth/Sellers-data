...
sheet = client.open("Bank").worksheet("KOTAK JULY FUT")
...
def fetch_and_save_data():
    ...
    if response.status_code == 401:
        ...
        total_sell_quantity = data['data']['NSE_FO:KOTAKBANK24JULFUT']['total_sell_quantity']
        total_buy_quantity = data['data']['NSE_FO:KOTAKBANK24JULFUT']['total_buy_quantity']
